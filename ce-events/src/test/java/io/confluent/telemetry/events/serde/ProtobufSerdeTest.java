...
public class ProtobufSerdeTest {
  ...
  String jsonAMessageEvent = "{\"data\":{\"anenum\":\"A\",\"astring\":\"my string\",\"along\":1029309,\"anint\":0,\"anotherstring\":\"\",\"secondString\":\"second string\"},\"id\":\"26e0a193-7c6e-4915-b6ee-41559d980d65\",\"source\":\"crn://authority/serde=source\",\"specversion\":\"0.3\",\"type\":\"AMessage\",\"time\":\"2020-05-09T01:02:12.031Z\",\"datacontenttype\":\"application/json\",\"subject\":\"crn://authority/serde=subject\"}";
  ...
  public void serializeStructured() {
    ...
    CloudEvent<AttributesImpl, AMessage> event = aMessageBuilder
        ...
        .build();
    ProducerRecord<String, byte[]> e = sf.producerRecord(event, "foo", 1);
    assertThat(new String(e.value())).isEqualTo(jsonAMessageEvent);
  }
  ...
  public void deserializeBinary() {
    ...
    h.add("ce_datacontenttype", Protobuf.APPLICATION_PROTOBUF.getBytes());

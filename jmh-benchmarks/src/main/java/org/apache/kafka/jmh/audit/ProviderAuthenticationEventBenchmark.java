...
public class ProviderAuthenticationEventBenchmark {
    ...
    public void setUp() {
        ...
        ProviderBenchmarkDefaults.allowProvider.setSanitizer(null);
        ProviderBenchmarkDefaults.denyProvider.setSanitizer(null);
    ...
    public static void main(String[] args) throws RunnerException {
        Options opt = new OptionsBuilder()
            .include(ProviderAuthenticationEventBenchmark.class.getSimpleName())
            .forks(2)
            .build();

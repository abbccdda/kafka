...
import org.apache.kafka.common.message.CreateClusterLinksResponseData.EntryData;
...
public class CreateClusterLinksResponse extends AbstractResponse {
    ...
    public CreateClusterLinksResponse(Map<String, ApiError> results, int throttleTimeMs) {
        ...
        this.data = new CreateClusterLinksResponseData()
    ...
    public CreateClusterLinksResponse(Struct struct, short version) {
        this.data = new CreateClusterLinksResponseData(struct, version);
    }

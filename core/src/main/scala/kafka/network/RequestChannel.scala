...
object RequestChannel extends Logging {
  ...
  class Request(val processor: Int,
    ...
    def updateRequestMetrics(networkThreadTimeNanos: Long, responseSendIoTimeNanos: Long, response: Response): Unit = {
      ...
      val responseSendIoTimeMs = nanosToMs(responseSendIoTimeNanos)
      ...
      metricNames.foreach { metricName =>
        ...
        m.responseSendIoTimeHist.update(Math.round(responseSendIoTimeMs))
      ...
      if (shouldLogRequest) {
        ...
        builder
          ...
          .append(",sendIoTime:").append(responseSendIoTimeMs)

...
object KafkaConfig {
  ...
  val SslEngineBuilderClassProp = SslConfigs.SSL_ENGINE_BUILDER_CLASS_CONFIG
  ...
  val SslEngineBuilderClassDoc = SslConfigs.SSL_ENGINE_BUILDER_CLASS_DOC
  ...
  private val configDef = {
    ...
    /** ********* Fetch Session Configuration **************/
      ...
      .define(SslEngineBuilderClassProp, STRING, Defaults.SslEngineBuilderClass, MEDIUM, SslEngineBuilderClassDoc)
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  val tierS3AwsAccessKeyId = getPassword(KafkaConfig.TierS3AwsAccessKeyIdProp)
  val tierS3AwsSecretAccessKey = getPassword(KafkaConfig.TierS3AwsSecretAccessKeyProp)

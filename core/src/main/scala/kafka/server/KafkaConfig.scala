...
object KafkaConfig {
  ...
  /** ********* Constants ***********/
  val TIER_S3_SSE_ALGORITHM_NONE = "none"
  ...
  private val configDef = {
    ...
    new ConfigDef()
      ...
      .defineInternal(ConfluentConfigs.BACKPRESSURE_REQUEST_MIN_BROKER_LIMIT_CONFIG, LONG,
        ConfluentConfigs.BACKPRESSURE_REQUEST_MIN_BROKER_LIMIT_DEFAULT, LOW, ConfluentConfigs.BACKPRESSURE_REQUEST_MIN_BROKER_LIMIT_DOC)
      .defineInternal(ConfluentConfigs.BACKPRESSURE_REQUEST_QUEUE_SIZE_PERCENTILE_CONFIG, STRING,
        ConfluentConfigs.BACKPRESSURE_REQUEST_QUEUE_SIZE_PERCENTILE_DEFAULT, LOW, ConfluentConfigs.BACKPRESSURE_REQUEST_QUEUE_SIZE_PERCENTILE_DOC)
      ...
      .defineInternal(ConfluentConfigs.MULTITENANT_LISTENER_PREFIX_ENABLE, BOOLEAN,
        ConfluentConfigs.MULTITENANT_LISTENER_PREFIX_ENABLE_DEFAULT, LOW, ConfluentConfigs.MULTITENANT_LISTENER_PREFIX_ENABLE_DOC)
...
class KafkaConfig(val props: java.util.Map[_, _], doLog: Boolean, dynamicConfigOverride: Option[DynamicBrokerConfig])
  ...
  def logDeletionMaxSegmentsPerRun = getInt(KafkaConfig.LogDeletionMaxSegmentsPerRunProp)
  ...
  val auditLogEnabled = getBoolean(KafkaConfig.AuditLogEnableProp)

...
import org.apache.kafka.common.message.{CreateAclsResponseData, CreatePartitionsResponseData, CreateTopicsResponseData, DeleteAclsResponseData, DeleteGroupsResponseData, DeleteTopicsResponseData, DescribeAclsResponseData, DescribeGroupsResponseData, EndTxnResponseData, OffsetDeleteResponseData, StopReplicaResponseData, UpdateMetadataResponseData}

...
public class S3TierObjectStoreConfig extends TierObjectStoreConfig {
    ...
    static S3TierObjectStoreConfig createWithEmptyClusterIdBrokerId(String bucket,
                                                                    ...
                                                                    String s3Prefix,
                                                                    String assumeRoleArn) {
        return new S3TierObjectStoreConfig(Optional.empty(), Optional.empty(), bucket, region, credFilePath,
                endpointOverride, signerOverride, sseAlgorithm, s3SseCustomerEncryptionKey, s3AutoAbortThresholdBytes,
                s3Prefix, assumeRoleArn);
    }

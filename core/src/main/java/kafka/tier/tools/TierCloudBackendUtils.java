...
class TierCloudBackendUtils {
     ...
     */
    static OptionParser augmentParserWithS3BackendOpts(OptionParser maybeExistingParser) {
     ...
     */
    static Properties addS3BackendProps(OptionSet options, Properties maybeExistingProps) {
        if (options == null)
            throw new IllegalArgumentException("Options need to be instantiated. See TierCloudBackendUtils.augmentParserWithCloudBackendOpts!");

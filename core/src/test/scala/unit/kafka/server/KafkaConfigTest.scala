  ...
  def testFromPropsInvalid(): Unit = {
    ...
    KafkaConfig.configNames().foreach(name => {
      name match {
        ...
        case KafkaConfig.OffsetsTopicPlacementConstraintsProp =>  // ignore string
        ...
        case KafkaConfig.TransactionsTopicPlacementConstraintsProp => // ignore string
        ...
        case KafkaConfig.SslEngineFactoryClassProp => // ignore string
        ...
        case ConfluentConfigs.BASIC_AUTH_CREDENTIALS_SOURCE_CONFIG =>
        case ConfluentConfigs.USER_INFO_CONFIG =>
        case ConfluentConfigs.BEARER_AUTH_CREDENTIALS_SOURCE_CONFIG =>
        case ConfluentConfigs.BEARER_AUTH_TOKEN_CONFIG =>
        case ConfluentConfigs.SSL_PROTOCOL_CONFIG =>
        case ConfluentConfigs.SSL_KEYSTORE_TYPE_CONFIG =>
        case ConfluentConfigs.SSL_KEYSTORE_LOCATION_CONFIG =>
        case ConfluentConfigs.SSL_KEYSTORE_PASSWORD_CONFIG =>
        case ConfluentConfigs.SSL_KEY_PASSWORD_CONFIG =>

...
public class NonBlockingKafkaExporterConfig extends AbstractConfig {
  ...
  // Keeping the same prefix (event.logger.exporter.kafka) for backwards compatibility
  public static final String KAFKA_EXPORTER_PREFIX = EVENT_LOGGER_PREFIX + "exporter.kafka.";

  public static final String EVENT_LOGGER_LOG_BLOCKING_CONFIG = KAFKA_EXPORTER_PREFIX + "blocking";

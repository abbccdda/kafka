...
CONFLUENT_TIER_TOPIC_DELETE_CHECK_INTERVAL_MS = "confluent.tier.topic.delete.check.interval.ms"
CONFLUENT_TIER_METADATA_REPLICATION_FACTOR = "confluent.tier.metadata.replication.factor"
CONFLUENT_TIER_METADATA_NUM_PARTITIONS = "confluent.tier.metadata.num.partitions"
...
CONFLUENT_TIER_S3_PREFIX = "confluent.tier.s3.prefix"
CONFLUENT_TIER_SEGMENT_ROLL_MIN_BYTES = "confluent.tier.segment.hotset.roll.min.bytes"
CONFLUENT_PREFER_TIER_FETCH_MS = "confluent.prefer.tier.fetch.ms"
CONFLUENT_TIER_SEGMENT_HOTSET_ROLL_MIN_BYTES = "confluent.tier.segment.hotset.roll.min.bytes"

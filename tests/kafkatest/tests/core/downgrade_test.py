...
class TestDowngrade(EndToEndTest):
    ...
    def setup_services(self, from_kafka_project, dist_version, kafka_version, compression_types, security_protocol, static_membership):
    ...
    def test_upgrade_and_downgrade(self, version, compression_types, security_protocol="PLAINTEXT", from_kafka_project="kafka", dist_version=None,
        ...
        self.setup_services(from_kafka_project, dist_version, kafka_version, compression_types, security_protocol, static_membership)
        self.await_startup()

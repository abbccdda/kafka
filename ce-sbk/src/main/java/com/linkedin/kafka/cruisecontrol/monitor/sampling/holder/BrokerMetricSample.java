...
public class BrokerMetricSample extends MetricSample<String, BrokerEntity> {
  ...
  public byte[] toBytes() {
    ...
    buffer.putDouble(metricValue(KafkaMetricDef.CPU_USAGE));
    buffer.putDouble(metricValue(KafkaMetricDef.LEADER_BYTES_IN));
    buffer.putDouble(metricValue(KafkaMetricDef.LEADER_BYTES_OUT));
    buffer.putDouble(metricValue(KafkaMetricDef.REPLICATION_BYTES_IN_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.REPLICATION_BYTES_OUT_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.MESSAGE_IN_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_REQUEST_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_REQUEST_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_REQUEST_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_REQUEST_HANDLER_POOL_IDLE_PERCENT));
    buffer.putDouble(metricValue(KafkaMetricDef.DISK_USAGE));
    buffer.putDouble(metricValue(KafkaMetricDef.PRODUCE_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.FETCH_RATE));
    buffer.putLong(_sampleTime);
    buffer.putInt(metricValue(KafkaMetricDef.BROKER_REQUEST_QUEUE_SIZE).intValue());
    buffer.putInt(metricValue(KafkaMetricDef.BROKER_RESPONSE_QUEUE_SIZE).intValue());
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_TOTAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_TOTAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_LOCAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_LOCAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_LOG_FLUSH_RATE));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_LOG_FLUSH_TIME_MS_MAX));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_LOG_FLUSH_TIME_MS_MEAN));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_REQUEST_QUEUE_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_REQUEST_QUEUE_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_REQUEST_QUEUE_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_TOTAL_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_TOTAL_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_TOTAL_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_TOTAL_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_LOCAL_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_PRODUCE_LOCAL_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_50TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_CONSUMER_FETCH_LOCAL_TIME_MS_999TH));
    buffer.putDouble(metricValue(KafkaMetricDef.BROKER_FOLLOWER_FETCH_LOCAL_TIME_MS_50TH));
  ...
  public Double metricFor(Resource resource) {
    switch (resource) {
      ...
      case NW_IN:
        return metricValue(KafkaMetricDef.LEADER_BYTES_IN) + metricValue(KafkaMetricDef.REPLICATION_BYTES_IN_RATE);
      case NW_OUT:
        return metricValue(KafkaMetricDef.LEADER_BYTES_OUT) + metricValue(KafkaMetricDef.REPLICATION_BYTES_OUT_RATE);
      default:

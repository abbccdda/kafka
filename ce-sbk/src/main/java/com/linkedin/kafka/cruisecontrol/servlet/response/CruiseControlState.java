...
public class CruiseControlState {
  ...
  protected String getPlaintext() {
    boolean verbose = false; // ((CruiseControlStateParameters) parameters).isVerbose();
    boolean superVerbose = false; // ((CruiseControlStateParameters) parameters).isSuperVerbose();

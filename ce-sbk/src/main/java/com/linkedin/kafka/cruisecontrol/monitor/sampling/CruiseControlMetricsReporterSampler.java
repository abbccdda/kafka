...
public class CruiseControlMetricsReporterSampler implements MetricSampler {
  ...
  public void configure(Map<String, ?> configs) {
    ...
    if (_metricReporterTopic == null) {
      ...
      if (_metricReporterTopic == null) {
        throw new ConfigException("CruiseControlMetricsReporterSampler needs a topic name for metrics samples.");
      }
    }
    ...
    // XXX: This should include the metric reporter's MAX_BLOCK_MS or LINGER_MS value as well.

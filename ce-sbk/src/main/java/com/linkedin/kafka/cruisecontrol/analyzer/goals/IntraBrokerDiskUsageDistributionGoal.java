...
public class IntraBrokerDiskUsageDistributionGoal extends AbstractGoal {
  ...
  protected void initGoalState(ClusterModel clusterModel, OptimizationOptions optimizationOptions) {
    ...
    for (Broker broker : brokersToBalance(clusterModel)) {
      ...
      _balanceUpperThresholdByBroker.put(broker, averageDiskUtilization * (1.0 + balancePercentageWithMargin));
      _balanceLowerThresholdByBroker.put(broker, averageDiskUtilization * Math.max(0, 1.0 - balancePercentageWithMargin));
    }
  }
